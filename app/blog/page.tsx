...
export const metadata: Metadata = {
  ...
  description: 'Découvrez nos articles sur le développement web, le SEO, et les dernières tendances du digital. Conseils d\'experts pour optimiser votre présence en ligne.',
  keywords: ['blog', 'développement web', 'SEO', 'conseils digital', 'Next.js', 'React', 'optimisation'],
  openGraph: {
