            ...
            <table className='min-w-full divide-y divide-slate-200'>
              <thead className='bg-slate-50'>
                <tr>
                  <th
                    scope='col'
                    className='py-4 pl-6 pr-3 text-left text-xs font-semibold text-slate-900 uppercase tracking-wider'>
                    Contact Info
                  </th>
                  <th
                    scope='col'
                    className='px-3 py-4 text-left text-xs font-semibold text-slate-900 uppercase tracking-wider'>
                    Project
                  </th>
                  <th
                    scope='col'
        ...
        <motion.div
          ...
          <div className='text-center'>
            ...
            <p className='mt-2 text-slate-500 max-w-sm mx-auto'>
              When clients contact you through the website contact form, their messages will appear
              here for you to review and respond to.
            </p>
            <div className='mt-8'>
