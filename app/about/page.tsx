            ...
            <div className='max-w-4xl mx-auto'>
              ...
              <div className='prose prose-lg max-w-none dark:prose-invert'>
                <p className='text-xl text-muted-foreground text-center mb-12'>
                  Votre agence web parisienne spécialisée en création de sites internet et
                ...
                <div className='grid md:grid-cols-2 gap-12 mb-16'>
                  <div>
                    ...
                    <p>
                      SIDIKOFF DIGITAL est une agence web basée à Paris, dédiée à accompagner les
                      entreprises, PME et associations dans leur transformation digitale. Nous
                      créons des sites internet performants, évolutifs et centrés sur l'utilisateur.
                    </p>
                    <p>
                      Notre approche est basée sur l'écoute, la qualité du code et la réussite de
                      vos projets. Nous allions expertise technique, créativité et sens du détail
                      pour livrer des expériences digitales sur mesure.
                    </p>
                  </div>
                ...
                <div className='bg-muted p-8 rounded-lg mb-16'>
                  <h2 className='text-2xl font-semibold mb-4 text-center'>
                    Pourquoi Choisir SIDIKOFF DIGITAL ?
                  </h2>
                ...
                <div className='text-center'>
                  <h2 className='text-2xl font-semibold mb-4'>
                    Basés à Paris, Rayonnement National
                  </h2>
