...
const translations: Record<Language, TranslationMap> = {
  fr: {
    ...
    'contact.placeholder.company': 'Nom de votre entreprise (optionnel)',
  ...
  en: {
    ...
    'contact.placeholder.company': 'Your company name (optional)',
    'contact.message': 'Message',
  ...
  ru: {
    ...
    'contact.placeholder.company': 'Название вашей компании (необязательно)',
