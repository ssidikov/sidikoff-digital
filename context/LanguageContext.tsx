...
const translations: Record<Language, TranslationMap> = {
  fr: {
    ...
    'prices.customDescription': 'Solutions sur mesure pour votre entreprise',    'prices.quote': 'Demander un devis',
    'prices.perProject': '/ projet',
  ...
  en: {
    ...
    'prices.customDescription': 'Tailored solutions for your business',    'prices.quote': 'Request a quote',
    'prices.perProject': '/ project',
  ...
  ru: {
    ...
    'prices.customDescription': 'Индивидуальные решения для вашего бизнеса',    'prices.quote': 'Запросить расчёт',
    'prices.perProject': '/ проект',
