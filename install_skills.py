...
os.makedirs(".agents/skills/seo", exist_ok=True)
os.makedirs(".agents/skills/seo/scripts", exist_ok=True)

print("Created target directories successfully.")

# Write SKILL.md
skill_md_content = """name: seo
description: >
...
with open(".agents/skills/seo/SKILL.md", "w", encoding="utf-8") as f:
