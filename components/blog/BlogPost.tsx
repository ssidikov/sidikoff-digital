...
export default function BlogPost({ post, relatedPosts, locale }: BlogPostProps) {
  ...
  const portableTextComponents = {
    ...
    block: {
      h1: ({ children }: any) => (
        <h1 className="text-3xl font-bold my-6 text-gray-900 dark:text-white">
          {children}
        </h1>
      ),
      h2: ({ children }: any) => (
        <h2 className="text-2xl font-bold my-5 text-gray-900 dark:text-white">
          {children}
        </h2>
      ),
      h3: ({ children }: any) => (
      ...
      h4: ({ children }: any) => (
        <h4 className="text-lg font-semibold my-3 text-gray-900 dark:text-white">
          {children}
        </h4>
      ),
      normal: ({ children }: any) => (
    ...
    list: {
      bullet: ({ children }: any) => (
        <ul className="my-4 pl-6 space-y-2 text-gray-700 dark:text-gray-300">
          {children}
        </ul>
      ),
      number: ({ children }: any) => (
              ...
              <div>
                ...
                {post.author.bio && (
                  <div className="text-gray-700 dark:text-gray-300">
                    <PortableText 
                      value={getLocalizedContent(post.author.bio, locale)} 
