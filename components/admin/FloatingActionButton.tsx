            ...
            {actions.map((action, index) => (
              ...
              >
                <button
                  ...
                  className={`flex items-center justify-center w-12 h-12 rounded-full shadow-lg transition-all duration-200 active:scale-95 ripple ${getActionColor(action.color)}`}
                  title={action.label}
                >
                  {action.icon}
                </button>
