          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className={`flex-shrink-0 h-5 w-5 rounded-full ${
                ...
                permission === 'denied' ? 'bg-red-400' : 'bg-gray-400'
              }`} />
              <div className="ml-3">
        ...
        <div className="mt-6 border-t border-gray-200 pt-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-4">
            <div className="text-sm text-blue-800">
              ...
              <ol className="mt-2 list-decimal list-inside space-y-1">
                <li><strong>Chrome Mobile:</strong> Tap &quot;Add to Home Screen&quot; in the browser menu</li>
                <li><strong>Safari Mobile:</strong> Tap the share button, then &quot;Add to Home Screen&quot;</li>
                <li><strong>Desktop:</strong> Look for the install icon in the address bar</li>
              </ol>
            </div>
          </div>
        </div>
