...
export default async function CafeParisPage() {
  const faqSchema = generateFAQStructuredData([
    {
      ...
      answer:
        'Le tarif varie selon le type de site et les fonctionnalités souhaitées. Contactez-nous pour un devis gratuit et personnalisé.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Oui. Chaque site est conçu avec une stratégie SEO locale Paris, pour maximiser la visibilité auprès des clients à proximité.',
    },
    {
      question: 'Puis-je gérer mon site moi-même après sa mise en ligne ?',
      answer:
        'Oui. Nous fournissons une formation simple pour mettre à jour vos menus, images et textes.',
    },
  ])
  ...
  const breadcrumbSchema = generateBreadcrumbStructuredData([
    ...
    {
      name: 'Creation Site Internet Cafe Paris',
      url: `${DEFAULT_SEO.siteUrl}/services/creation-site-internet-cafe-paris`,
    },
  ])
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    <strong>Présenter vos menus</strong> et spécialités (café, boissons,
                    pâtisseries, brunch).
                  </p>
                </div>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Présentez votre café avec un <strong>design moderne</strong>, vos horaires,
                    votre adresse et vos valeurs.
                  </p>
                  <Link
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Optimisation des contenus, balises meta, Google Business Profile, avis clients
                    et géolocalisation pour apparaître en haut des recherches :<em>café Paris</em>,{' '}
            ...
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='space-y-8'>
                ...
                <div className='bg-linear-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    Oui. Nous fournissons une formation simple pour mettre à jour vos menus, images
                    et textes.
                  </p>
                </div>
              </div>
