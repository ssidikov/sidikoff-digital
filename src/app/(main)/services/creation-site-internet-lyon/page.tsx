...
export default async function LyonPage() {
  const breadcrumbSchema = generateBreadcrumbStructuredData([
    ...
    {
      name: 'Restauration & gastronomie',
      url: `${DEFAULT_SEO.siteUrl}/services/creation-site-internet-lyon`,
    },
  ])
              ...
              <div className='space-y-8'>
                <div className='space-y-4'>
                  ...
                  <p className='text-xl text-gray-600 leading-relaxed'>
                    ...
                    <strong>Lyon</strong> et vous souhaitez booster votre visibilité en ligne ?
                    Notre <strong>agence web à Lyon</strong> vous accompagne dans la{' '}
        ...
        <div className='flex flex-col gap-0'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Un <strong>site vitrine professionnel</strong> pour mettre en valeur vos
                    services et séduire vos prospects à Lyon et dans la région Auvergne-Rhône-Alpes.
                  </p>
                  <Link
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Développement de <strong>sites e-commerce fiables et sécurisés</strong> :
                    gestion des produits, paiement en ligne, design responsive et optimisation SEO.
                  </p>
                  <Link
                    href='/services/creation-sites-web'
                    className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
              ...
              <div className='space-y-6'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    ...
                    <strong>site e-commerce</strong> nécessite 4 à 8 semaines. Nous proposons aussi
                    un service express pour les projets urgents. Un planning détaillé est remis dès
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    ...
                    chargement (Core Web Vitals), et fiche <strong>Google Business Profile</strong>.
                    Nos sites en Next.js obtiennent systématiquement des scores Lighthouse &gt; 95
                    dans toute la <strong>Métropole de Lyon</strong>.
                  </p>
                </div>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    ...
                    <strong>forfaits de maintenance mensuelle</strong> (dès 49€/mois) comprennent
                    les mises à jour, le monitoring 24/7 et un support technique réactif.
                  </p>
                </div>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    ...
                    <strong>Métropole de Lyon</strong>. Un <strong>site e-commerce</strong> permet
                    en plus de vendre en ligne : gestion des stocks, paiement sécurisé (Stripe,
                    PayPal) et suivi des commandes. Dans les deux cas, le{' '}
                    <strong>référencement local à Lyon</strong> et le design responsive sont inclus
                    pour maximiser votre visibilité sur Google.
                  </p>
                </div>
              </div>
              ...
              <div className='grid lg:grid-cols-2 gap-16 items-start'>
                <div>
                  ...
                  <div className='space-y-5 text-lg text-gray-700 leading-relaxed'>
                    <p>
                      Lyon est la troisième métropole française, avec un tissu économique
                      exceptionnel : plus de 160 000 entreprises dans la métropole, une scène
                      startup dynamique autour de <strong>Confluence et Part-Dieu</strong>, et des
                      secteurs porteurs comme la santé (Biopôle), la gastronomie, le luxe et les
                      industries numériques. Dans cet environnement concurrentiel, votre site web
                      est votre premier argument commercial.
                    </p>
                    <p>
                      Un client lyonnais effectue sa recherche sur Google avant tout contact
                      téléphonique. Si votre site n'apparaît pas dans les{' '}
                      <strong>3 premiers résultats locaux</strong>, vous perdez la majorité de vos
                      prospects au profit de concurrents mieux positionnés. Notre stratégie SEO
                      locale pour Lyon cible précisément les quartiers où se trouvent vos clients :
                      Presqu'île, Croix-Rousse, Monplaisir, Gerland, Vaise, La Guillotière ou
                      Villeurbanne.
                    </p>
                    <p>
                      Depuis 2024, Google évalue la qualité d'un site via les{' '}
                      <strong>Core Web Vitals</strong> : vitesse de chargement (LCP &lt; 2,5s),
                      interactivité (INP &lt; 200ms) et stabilité visuelle (CLS &lt; 0,1). Nos sites
                      construits en <strong>Next.js</strong> atteignent systématiquement des scores
                      Lighthouse supérieurs à 95, ce qui se traduit par un meilleur positionnement
                      et une meilleure expérience pour vos visiteurs.
                    </p>
                    <p>
                      En tant qu'agence web lyonnaise, nous intervenons aussi bien pour des{' '}
                      <strong>boutiques du vieux Lyon</strong>, des{' '}
                      <strong>restaurants bouchons</strong>, des cabinets d'avocats de la Part-Dieu,
                      des cabinets médicaux et des PME industrielles de la zone de Vénissieux ou
                      Saint-Priest. Chaque projet est contextualisé à votre marché local.
                    </p>
                  </div>

                  {/* Internal linking hub */}
                  <div className='mt-8 p-6 bg-[#DBE2EF]/30 rounded-2xl border border-[#3F72AF]/20'>
                    <h3 className='text-lg font-bold text-[#112D4E] mb-4'>
                      Nos pages locales connexes
                    </h3>
                    <div className='flex flex-wrap gap-3'>
                      <Link
                        href='/services/agence-web-lyon'
                        className='text-sm text-[#3F72AF] hover:text-[#112D4E] hover:underline font-medium'>
                        → Agence web Lyon
                      </Link>
                      <Link
                        href='/services/agence-web-villeurbanne'
                      ...
                      <Link
                        href='/services/creation-site-internet-toulouse'
                        className='text-sm text-[#3F72AF] hover:text-[#112D4E] hover:underline font-medium'>
                ...
                <div>
                  <h3 className='text-2xl font-bold text-[#112D4E] mb-6'>
                    Pour qui créons-nous des sites à Lyon ?
                  </h3>
                  <div className='space-y-4'>
                    {[
                      {
                      ...
                      <div
                        key={i}
                        className='flex gap-4 p-4 bg-[#F8F9FA] rounded-xl border border-gray-100 hover:border-[#3F72AF]/30 transition-colors'>
          ...
          <Section className='py-20 bg-[#F8F9FA]'>
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='space-y-5 text-lg text-gray-700 leading-relaxed'>
                <p>
                  Sidikoff Digital est une <strong>agence digitale à Lyon</strong> spécialisée dans
                  la <strong>création de sites internet sur mesure</strong>, la{' '}
                ...
                <p>
                  Chaque projet de <strong>création de site internet à Lyon</strong> commence par
                  une analyse approfondie : étude de votre marché local, recherche des{' '}
                  <strong>mots-clés à fort potentiel dans le 69</strong>, audit de la concurrence
                  dans votre secteur (restauration, santé, B2B, e-commerce, artisanat). Nous
                  définissons ensuite une architecture de l&apos;information optimisée pour Google
                  et pour vos visiteurs — deux impératifs qui vont aujourd&apos;hui de pair.
                </p>
                <p>
                  Notre stack technique — <strong>Next.js</strong>, React, Tailwind CSS et Sanity
                  CMS — garantit des performances de haut niveau : chargement instantané (LCP{' '}
                  <strong>&lt; 2,5s</strong>), stabilité visuelle (CLS = 0) et interactivité
                  irréprochable (INP &lt; 200ms). Ces métriques <strong>Core Web Vitals</strong> ne
                  sont pas cosmétiques : Google les intègre directement dans son algorithme de
                  classement. Résultat : vos concurrents sur des{' '}
