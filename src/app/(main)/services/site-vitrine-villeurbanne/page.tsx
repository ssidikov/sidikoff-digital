...
export function generateMetadata(): Metadata {
  const title = 'Création Site Vitrine Villeurbanne | Agence Web Sur-Mesure'
  const description = 'Confiez la création de votre site vitrine à notre agence web. Design sur-mesure, optimisation mobile et SEO local performant sur Villeurbanne et Grand Lyon.'
  
  return {
    title,
    description,
    keywords: 'création site vitrine villeurbanne, agence web villeurbanne, site internet vitrine villeurbanne, développeur web villeurbanne, refonte site web',
    openGraph: {
      title,
      description,
      type: 'website',
    ...
    alternates: {
      canonical: PAGE_URL,
      languages: generateAlternateUrls('services/site-vitrine-villeurbanne'),
    },
...
export default function SiteVitrineVilleurbanneLandingPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbStructuredData([
    ...
    { name: 'Site Vitrine Villeurbanne', url: PAGE_URL },
  ])
