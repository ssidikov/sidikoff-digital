...
export function generateMetadata(): Metadata {
  const title = 'Refonte Site Web Lyon | Agence Migration & Design'
  const description = 'Agence experte en refonte de site web à Lyon. Modernisez votre design, boostez vos performances (Next.js) et sécurisez votre trafic SEO lors de la migration.'
  
  return {
    title,
    description,
    keywords: 'refonte site web lyon, refonte site internet lyon, agence web lyon, migration seo lyon, moderniser site web',
    openGraph: {
      title,
      description,
      type: 'website',
    ...
    alternates: {
      canonical: PAGE_URL,
      languages: generateAlternateUrls('services/refonte-site-web-lyon'),
    },
...
const localBusinessSchema = {
  ...
  "description": "Experts en refonte de site internet à Lyon, spécialisés dans la migration de données et la préservation du référencement naturel.",
  "url": "https://www.sidikoff.com/services/refonte-site-web-lyon",
...
export default function RefonteSiteWebLyonLandingPage() {
  ...
  const breadcrumbSchema = generateBreadcrumbStructuredData([
    ...
    { name: 'Refonte Site Web Lyon', url: PAGE_URL },
  ])
