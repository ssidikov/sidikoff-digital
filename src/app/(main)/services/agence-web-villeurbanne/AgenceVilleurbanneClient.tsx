    ...
    <div className='relative min-h-screen bg-[#F9F7F7] text-[#112D4E] pt-32 pb-20 font-sans overflow-x-hidden'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center'>
          ...
          <div className='lg:col-span-7 flex flex-col items-start text-left'>
            ...
            <p className='text-base md:text-lg text-[#112D4E]/85 max-w-xl mb-10 leading-relaxed font-light'>
              Nous concevons des plateformes web ultra-rapides et développons votre visibilité sur
              Google à Villeurbanne. Pas de template générique, uniquement du code sur mesure pensé
              pour capter vos futurs clients.
            </p>
            ...
            <div className='mt-8 flex flex-col items-start gap-1 text-[11px] uppercase tracking-wider font-semibold text-[#112D4E]/60'>
              <p>
                Par <span className='text-[#112D4E]'>Sardorbek Sidikov</span> — Sidikoff Digital
              </p>
              <p>Mis à jour le 27 Juin 2026</p>
            </div>
          </div>
      ...
      <section className='relative z-10 w-full border-y border-[#DBE2EF]/60 bg-white/40 py-6 overflow-hidden mb-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-center items-center gap-12 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-300'>
          <span className='text-sm font-bold tracking-widest text-[#112D4E]/80 uppercase'>
            React
          </span>
          <span className='text-sm font-bold tracking-widest text-[#112D4E]/80 uppercase'>
            Next.js
      ...
      <section
        id='expertise'
        className='relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-24 scroll-mt-28'>
        <div className='mb-12'>
            ...
            <div className='bg-white p-8 rounded-[calc(2rem-0.625rem)] flex flex-col h-full'>
              ...
              <p className='text-sm text-[#112D4E]/80 leading-relaxed font-light mb-6'>
                ...
                <Link
                  ...
                  className='text-[#3377FF] underline underline-offset-2 hover:text-[#112D4E] transition-colors'>
                  sites vitrines
                </Link>{' '}
                et plateformes{' '}
                <Link
                ...
                à fort taux de conversion. Conception Next.js / React optimisée pour une vitesse
                d&apos;affichage instantanée.
              </p>
              <div className='mt-auto flex flex-wrap gap-2'>
                {['Next.js', 'React', 'TypeScript'].map((t) => (
                  <span
                    key={t}
                    className='px-2.5 py-1 bg-[#F9F7F7] text-[#112D4E]/70 text-[10px] font-bold uppercase rounded-md tracking-wider'>
                    {t}
                  </span>
                ))}
              </div>
          ...
          <motion.div
            ...
            <div className='bg-gradient-to-br from-[#112D4E] to-[#1e3e6b] p-8 rounded-[calc(2rem-0.625rem)] flex flex-col h-full relative overflow-hidden'>
              ...
              <p className='text-sm text-white/80 leading-relaxed font-light mb-6'>
                Positionnement ciblé sur Villeurbanne, Lyon et Gratte-Ciel. Nous optimisons
                l&apos;aspect technique de votre site et vos contenus pour capter les requêtes clés
                de vos futurs clients. Découvrez notre{' '}
                <Link
                  href='/services/seo-villeurbanne'
                  className='text-[#3377FF] underline underline-offset-2 hover:text-white transition-colors'>
                  expertise SEO à Villeurbanne
                </Link>
                .
              </p>
              <div className='mt-auto flex flex-wrap gap-2'>
                {['SEO Local', 'JSON-LD', 'Audit'].map((t) => (
                  <span
                    key={t}
                    className='px-2.5 py-1 bg-white/10 text-white/95 text-[10px] font-bold uppercase rounded-md tracking-wider'>
                    {t}
                  </span>
                ))}
              </div>
          ...
          <motion.div
            ...
            <div className='bg-white p-6 rounded-[calc(2rem-0.625rem)] flex flex-col h-full'>
              ...
              <p className='text-xs text-[#112D4E]/80 leading-relaxed font-light'>
                Automatisation de vos processus internes, création d&apos;outils CRM/ERP simplifiés
                et intégration d&apos;APIs pour une efficacité opérationnelle maximale.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center'>
          ...
          <div className='lg:col-span-7 flex flex-col items-start text-left'>
            ...
            <div className='space-y-6 text-base text-[#112D4E]/80 font-light leading-relaxed'>
              <p>
                Deuxième commune de la métropole avec plus de 150 000 habitants,{' '}
                <strong className='font-semibold text-[#112D4E]'>Villeurbanne</strong> possède une
                vitalité économique unique. Des boutiques animées du Cours Émile Zola aux
                restaurants branchés des Gratte-Ciel, en passant par les start-ups technologiques de
                La Doua et le secteur résidentiel de Cusset, chaque quartier a ses codes.
              </p>
              <p>
                Contrairement aux marchés saturés de Lyon intramuros, Villeurbanne offre
                d&apos;immenses opportunités de positionnement local sur Google. Notre{' '}
                <Link
                  href='/services/agence-web-lyon'
                  className='text-[#3377FF] underline underline-offset-2 hover:text-[#112D4E] transition-colors'>
                  agence web
                </Link>{' '}
                maîtrise parfaitement le marché local pour concevoir un{' '}
                <Link
                  href='/services/creation-site-internet-lyon'
                  className='text-[#3377FF] underline underline-offset-2 hover:text-[#112D4E] transition-colors'>
                  site internet
                </Link>{' '}
                qui répond directement aux attentes des professionnels du Grand Lyon.
              </p>
            </div>
          ...
          {[
            ...
            <motion.div
              ...
              <div className='bg-white p-8 rounded-[calc(2rem-0.625rem)] flex flex-col h-full'>
                ...
                <p className='text-sm text-[#112D4E]/80 leading-relaxed font-light'>{item.desc}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
      ...
      <section className='relative z-10 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto mb-24'>
        <div className='mb-12'>
          ...
          <p className='mt-4 text-base text-[#112D4E]/70 font-light max-w-2xl'>
            Chaque projet est une collaboration. Voici les retours de nos clients à Lyon et
            Villeurbanne.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-start'>
          <div className='lg:col-span-5'>
            ...
            <p className='text-base text-[#112D4E]/80 font-light leading-relaxed max-w-md'>
              Nous appliquons un processus rigoureux de l&apos;audit initial à la mise en ligne pour
              assurer la performance technique et le succès SEO de votre site.
            </p>
          </div>
            ...
            {[
              ...
              <div
                ...
                <div>
                  ...
                  <p
                    className='text-sm text-[#112D4E]/80 font-light leading-relaxed'
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
          <div className='lg:col-span-5 flex flex-col items-start text-left'>
            ...
            <div className='space-y-4 text-base text-[#112D4E]/80 font-light leading-relaxed'>
              <p>
                Notre agence est située dans le quartier{' '}
                <strong className='font-semibold text-[#112D4E]'>Gratte-Ciel</strong>, au centre de
                Villeurbanne — à quelques minutes du métro.
              </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {[
            ...
            <Link
              ...
              <p className='text-xs text-[#112D4E]/80 leading-relaxed font-light'>{item.desc}</p>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className='relative z-10 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto'>
        <motion.div
          ...
          <p className='text-sm md:text-base text-white/80 font-light mb-8 max-w-xl mx-auto leading-relaxed'>
            Discutons de vos objectifs et élaborons une stratégie sur mesure pour propulser votre
            présence numérique à Lyon et Villeurbanne.
          </p>
          <CTAButton
            href='/contact'
            variant='outline'
