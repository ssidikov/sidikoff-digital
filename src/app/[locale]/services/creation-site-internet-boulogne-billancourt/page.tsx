...
export async function generateMetadata({ params }: BoulogneBillancourtPageProps): Promise<Metadata> {
  ...
  return {
    ...
    twitter: {
      ...
      title,
      description,
      images: [`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.sidikoff.com'}/images/og-creation-sites-web.jpg`],
    },
    keywords:
      locale === 'fr'
...
export default async function BoulogneBillancourtPage({ params }: BoulogneBillancourtPageProps) {
  ...
  const content = {
    fr: {
      ...
      showcase_desc: 'Présentez votre entreprise, vos horaires, votre adresse et vos valeurs avec un design moderne et responsive.',
      ecommerce_title: 'Site e-commerce performant',
      ecommerce_desc: 'Vente en ligne de produits, services ou abonnements avec paiement sécurisé, catalogue intuitif et interface simple à gérer.',
      features_title: 'Fonctionnalités personnalisées',
      features: [
        'Site multilingue (FR/EN/RU) pour toucher une clientèle locale et internationale',
      ...
      seo_desc: 'Optimisation complète des contenus, balises meta, vitesse, Core Web Vitals, et stratégie de mots-clés ciblant Boulogne-Billancourt et Île-de-France.',
      design_title: 'Design & expérience utilisateur',
      design_desc: 'Navigation fluide, responsive design, visuels attractifs et conversion optimisée pour transformer vos visiteurs en clients.',
      maintenance_title: 'Maintenance & support technique',
      maintenance_desc: 'Mises à jour régulières, sécurité renforcée, sauvegardes automatiques et assistance continue pour assurer la performance de votre site.',
      ...
      portfolio_desc: 'Découvrez nos réalisations pour des entreprises à Boulogne-Billancourt et dans les Hauts-de-Seine.',
      ...
      faq: [
        {
          ...
          answer: 'Le tarif dépend du type de site et des fonctionnalités souhaitées. Contactez-nous pour un devis gratuit et personnalisé.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Oui. Tous nos sites sont optimisés pour le SEO local Boulogne-Billancourt et apparaissent en tête des résultats Google.'
        },
        {
          question: 'Puis-je gérer mon site moi-même après sa mise en ligne ?',
          answer: 'Oui. Nous fournissons un CMS simple et une formation pour mettre à jour vos textes, images et contenus.'
        }
      ],
      contact_title: 'Demandez votre devis gratuit',
      contact_desc: 'Boostez votre visibilité à Boulogne-Billancourt (92) avec un site web moderne, performant et multilingue, conçu pour attirer de nouveaux clients et renforcer votre image.',
    ...
    en: {
      ...
      intro: 'Are you a business, craftsman, or startup in Boulogne-Billancourt looking to develop your online presence? Our specialized web agency supports businesses in creating custom, modern, high-performing websites optimized for local SEO in Boulogne-Billancourt. Whether for a showcase website, e-commerce site, or multilingual website, we have the solution to boost your visibility and attract new customers.',
      ...
      showcase_desc: 'Present your business, hours, address, and values with modern, responsive design.',
      ecommerce_title: 'High-performance e-commerce site',
      ecommerce_desc: 'Online sale of products, services, or subscriptions with secure payment, intuitive catalog, and easy-to-manage interface.',
      features_title: 'Custom features',
      features: [
        'Multilingual website (FR/EN/RU) to reach local and international clientele',
      ...
      seo_desc: 'Complete optimization of content, meta tags, speed, Core Web Vitals, and keyword strategy targeting Boulogne-Billancourt and Île-de-France.',
      design_title: 'Design & user experience',
      design_desc: 'Smooth navigation, responsive design, attractive visuals, and optimized conversion to turn your visitors into customers.',
      maintenance_title: 'Maintenance & technical support',
      maintenance_desc: 'Regular updates, enhanced security, automatic backups, and continuous assistance to ensure your site\'s performance.',
      ...
      portfolio_desc: 'Discover our achievements for businesses in Boulogne-Billancourt and Hauts-de-Seine.',
      ...
      faq: [
        {
          ...
          answer: 'The price depends on the type of site and desired features. Contact us for a free, personalized quote.'
        },
        {
        ...
        },
        {
          ...
          answer: 'Yes. All our sites are optimized for Boulogne-Billancourt local SEO and appear at the top of Google results.'
        },
        {
          question: 'Can I manage my site myself after it goes live?',
          answer: 'Yes. We provide a simple CMS and training to update your texts, images, and content.'
        }
      ],
      contact_title: 'Request your free quote',
      contact_desc: 'Boost your visibility in Boulogne-Billancourt (92) with a modern, high-performing, multilingual website designed to attract new customers and strengthen your image.',
    ...
    ru: {
      ...
      intro: 'Вы бизнес, ремесленник или стартап в Булонь-Бийанкур и хотите развивать свое онлайн-присутствие? Наше специализированное веб-агентство помогает компаниям создавать индивидуальные, современные, высокопроизводительные сайты, оптимизированные для локального SEO в Булонь-Бийанкур. Будь то сайт-витрина, интернет-магазин или многоязычный сайт, у нас есть решение для повышения вашей видимости и привлечения новых клиентов.',
      ...
      showcase_desc: 'Представьте свой бизнес, часы работы, адрес и ценности с современным, адаптивным дизайном.',
      ecommerce_title: 'Высокопроизводительный интернет-магазин',
      ecommerce_desc: 'Онлайн-продажа товаров, услуг или подписок с безопасной оплатой, интуитивным каталогом и простым в управлении интерфейсом.',
      features_title: 'Персональные функции',
      features: [
        'Многоязычный сайт (FR/EN/RU) для охвата местной и международной клиентуры',
      ...
      seo_desc: 'Полная оптимизация контента, мета-тегов, скорости, Core Web Vitals и стратегии ключевых слов, нацеленных на Булонь-Бийанкур и Иль-де-Франс.',
      design_title: 'Дизайн и пользовательский опыт',
      design_desc: 'Плавная навигация, адаптивный дизайн, привлекательные визуалы и оптимизированная конверсия для превращения посетителей в клиентов.',
      maintenance_title: 'Обслуживание и техническая поддержка',
      maintenance_desc: 'Регулярные обновления, усиленная безопасность, автоматические резервные копии и непрерывная помощь для обеспечения производительности вашего сайта.',
      ...
      portfolio_desc: 'Откройте для себя наши достижения для предприятий в Булонь-Бийанкур и О-де-Сен.',
      faq_title: 'FAQ – Создание сайтов Булонь-Бийанкур',
      faq: [
        {
          question: 'Какова цена создания сайта в Булонь-Бийанкур?',
          answer: 'Цена зависит от типа сайта и желаемых функций. Свяжитесь с нами для бесплатного, персонализированного предложения.'
        },
        {
          question: 'Сколько времени занимает создание сайта?',
          answer: 'В среднем 4-8 недель, в зависимости от сложности проекта и предоставленного контента.'
        },
        {
          question: 'Будет ли мой сайт виден в Google?',
          answer: 'Да. Все наши сайты оптимизированы для локального SEO Булонь-Бийанкур и появляются в топе результатов Google.'
        },
        {
          question: 'Смогу ли я управлять сайтом самостоятельно после запуска?',
          answer: 'Да. Мы предоставляем простую CMS и обучение для обновления ваших текстов, изображений и контента.'
        }
      ],
      contact_title: 'Запросите бесплатное предложение',
      contact_desc: 'Повысьте свою видимость в Булонь-Бийанкур (92) с современным, высокопроизводительным, многоязычным сайтом, предназначенным для привлечения новых клиентов и укрепления вашего имиджа.',
