...
export async function generateMetadata({ params }: ParisPageProps): Promise<Metadata> {
  ...
  return {
    ...
    twitter: {
      ...
      title,
      description,
      images: [`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.sidikoff.com'}/images/og/creation-sites-web-paris.jpg`],
    },
  }
}
              ...
              <div className='space-y-8'>
                <div className='space-y-4'>
                  ...
                  <p className='text-xl text-gray-600 leading-relaxed'>
                    Paris web agency specialized in custom website creation. Whether showcase or e-commerce sites, 
            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div className='space-y-8'>
                <div className='space-y-4'>
                  ...
                  <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-[#112D4E] leading-tight'>
                    Профессиональное создание сайтов в <span className='text-[#3F72AF]'>Париже</span>
                  </h1>
                  <p className='text-xl text-gray-600 leading-relaxed'>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div className='space-y-8'>
              <div className='space-y-4'>
                ...
                <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-[#112D4E] leading-tight'>
                  Création de site internet professionnel à <span className='text-[#3F72AF]'>Paris</span>
                </h1>
                <p className='text-xl text-gray-600 leading-relaxed'>
                  Vous êtes une entreprise, un artisan, une startup ou un indépendant basé à <strong>Paris</strong> et vous souhaitez développer votre visibilité en ligne ?
                  Notre <strong>agence web à Paris</strong> est spécialisée dans la <strong>création de sites internet sur mesure</strong>.
                </p>
              </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                ...
                avec un référencement optimisé pour <strong>Google</strong> et un design moderne adapté à vos clients.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Un <strong>site vitrine professionnel</strong> pour présenter vos services, attirer de nouveaux clients 
                  et renforcer votre image à Paris et en Île-de-France.
                </p>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Développement de <strong>sites e-commerce performants</strong> : gestion de catalogue produits, 
                  paiement sécurisé, design responsive et optimisé pour le SEO.
                </p>
                <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                  En savoir plus
                  <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Création de fonctionnalités personnalisées, intégration d&apos;API, mise en place de solutions 
                  adaptées à vos besoins spécifiques à Paris.
                </p>
                <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                  En savoir plus
                  <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Optimisation complète (balises, vitesse, mobile friendly, maillage interne) et stratégie de mots-clés 
                  ciblant Paris pour apparaître en tête des résultats Google.
                </p>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Conception de sites intuitifs, rapides et esthétiques. Expérience utilisateur optimisée 
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Maintenance & accompagnement</h3>
                <p className='text-gray-600 mb-6'>
                  Mises à jour, sécurité, sauvegardes, support technique réactif, avec un suivi continu 
                  pour assurer la performance de votre site.
                </p>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Une agence basée à Paris, au plus proche de vos besoins.</p>
              </div>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Visibilité renforcée dans les recherches &ldquo;création site internet Paris&rdquo;.</p>
              </div>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Trafic qualifié, nouveaux prospects, croissance digitale.</p>
              </div>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Pas de frais cachés, vous savez exactement ce que vous payez.</p>
              </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid md:grid-cols-5 gap-8'>
              <div className='text-center'>
                ...
                <h3 className='text-lg font-bold text-[#112D4E] mb-3'>Audit & stratégie digitale</h3>
                <p className='text-gray-600'>Analyse de votre marché parisien et de vos concurrents.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Maquettes personnalisées selon votre identité visuelle.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Textes adaptés à Paris, balises meta, vitesse et sécurité.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Indexation Google, ajustements et analyse des performances.</p>
              </div>
            </div>
          </div>
        </Section>
            ...
            <div className='space-y-8'>
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                ...
                <p className='text-gray-600'>
                  Le tarif dépend du type de site (vitrine, e-commerce, fonctionnalités). Chaque projet est unique. 
                  Contactez-nous pour un <strong>devis personnalisé gratuit</strong>.
                </p>
              </div>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                ...
                <p className='text-gray-600'>
                  En moyenne entre <strong>4 et 8 semaines</strong>, selon la taille du projet et le contenu fourni.
                </p>
              </div>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                ...
                <p className='text-gray-600'>
                  Oui. Tous nos sites sont optimisés pour le <strong>référencement SEO à Paris</strong>, 
        ...
        <Section className='py-20 bg-gradient-to-br from-[#112D4E] to-[#3F72AF] text-white'>
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-xl mb-8 opacity-90'>
              Prêt à booster votre visibilité en ligne et à attirer de nouveaux clients à Paris ?<br />
              Confiez-nous la <strong>création de votre site internet professionnel</strong> et bénéficiez d&apos;un site moderne, performant et optimisé pour le SEO.
            </p>
