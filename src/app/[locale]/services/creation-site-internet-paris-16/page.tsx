                ...
                <div className='grid lg:grid-cols-2 gap-12 items-center'>
                  ...
                  <div className='text-center lg:text-left'>
                    ...
                    <p className='text-xl text-gray-600 mb-8 leading-relaxed'>
                      Développeur web local expert en design sur-mesure et SEO. Transformez votre
                      présence digitale en machine à clients.
                    </p>
              ...
              <div className='grid lg:grid-cols-2 gap-12 items-center mb-20'>
                <div className='space-y-6'>
                  ...
                  <p className='text-lg text-gray-700 leading-relaxed'>
                    ...
                    des sites internet parfaitement adaptés aux besoins spécifiques des entreprises
                    du 16ème arrondissement. Nous concevons chaque{' '}
                    <strong>site web sur-mesure</strong> en intégrant les dernières technologies et
                    en respectant les standards de <strong>design responsive</strong>.
                  </p>
