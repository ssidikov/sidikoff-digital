...
export async function generateMetadata({ params }: Paris16PageProps): Promise<Metadata> {
  ...
  const description = 'SIDIKOFF DIGITAL, agence web 75016, est spécialisée dans la création de sites Internet et le webmarketing. Contactez-nous dès maintenant.'
