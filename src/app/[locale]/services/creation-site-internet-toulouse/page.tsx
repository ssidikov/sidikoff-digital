...
export async function generateMetadata({ params }: ToulousePageProps): Promise<Metadata> {
  ...
  return {
    ...
    twitter: {
      ...
      title,
      description,
      images: [`${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.sidikoff.com'}/images/og/creation-sites-web-toulouse.jpg`],
    },
  }
}
              ...
              <div className='space-y-8'>
                <div className='space-y-4'>
                  ...
                  <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-[#112D4E] leading-tight'>
                    Professional Website Creation in <span className='text-[#3F72AF]'>Toulouse</span>
                  </h1>
                  <p className='text-xl text-gray-600 leading-relaxed'>
                    Toulouse web agency specialized in custom website creation. Whether showcase or e-commerce sites, 
            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div className='space-y-8'>
                <div className='space-y-4'>
                  ...
                  <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-[#112D4E] leading-tight'>
                    Профессиональное создание сайтов в <span className='text-[#3F72AF]'>Тулузе</span>
                  </h1>
                  <p className='text-xl text-gray-600 leading-relaxed'>
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <div className='space-y-8'>
              <div className='space-y-4'>
                ...
                <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-[#112D4E] leading-tight'>
                  Création de site internet professionnel à <span className='text-[#3F72AF]'>Toulouse</span>
                </h1>
                <p className='text-xl text-gray-600 leading-relaxed'>
                  Vous êtes une entreprise, un artisan, une startup ou un indépendant basé à <strong>Toulouse</strong> et vous souhaitez développer votre visibilité en ligne ?
                  Notre <strong>agence web à Toulouse</strong> est experte dans la <strong>création de sites internet sur mesure</strong>.
                </p>
              </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Qu&apos;il s&apos;agisse de <strong>sites vitrines</strong> ou de <strong>sites e-commerce</strong>, 
                optimisés pour le <strong>référencement SEO local</strong> et conçus pour générer de nouveaux clients.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Un <strong>site vitrine professionnel</strong> pour présenter vos services et vos atouts 
                  auprès de la clientèle toulousaine et occitane.
                </p>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Développement de <strong>boutiques en ligne</strong> avec paiement sécurisé, gestion des produits, 
                  design responsive et référencement SEO optimisé pour Toulouse et au-delà.
                </p>
                <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                  En savoir plus
                  <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Référencement SEO Toulouse</h3>
                <p className='text-gray-600 mb-6'>
                  Optimisation technique et éditoriale pour vous positionner sur les mots-clés stratégiques comme 
                  <em>&ldquo;création site internet Toulouse&rdquo;</em> ou <em>&ldquo;agence web Toulouse&rdquo;</em>.
                </p>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Web design & expérience utilisateur</h3>
                <p className='text-gray-600 mb-6'>
                  Sites modernes, rapides et esthétiques, pensés pour offrir une <strong>expérience utilisateur fluide</strong> 
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                ...
                <p className='text-gray-600 mb-6'>
                  Mises à jour, sécurité, sauvegardes automatiques, assistance réactive avec un suivi continu.
                </p>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <h3 className='text-xl font-bold text-[#112D4E] mb-3'>Connaissance du marché local</h3>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Optimisation pour apparaître en tête des recherches à Toulouse et en Occitanie.</p>
              </div>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <h3 className='text-xl font-bold text-[#112D4E] mb-3'>Accompagnement personnalisé</h3>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Devis gratuit, tarifs adaptés, aucune mauvaise surprise.</p>
              </div>
              ...
              <div className='bg-white/80 backdrop-blur-sm rounded-xl p-6 text-center shadow-lg border border-white/20'>
                ...
                <p className='text-gray-600'>Augmentation de la visibilité, nouveaux clients, croissance durable.</p>
              </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid md:grid-cols-5 gap-8'>
              <div className='text-center'>
                ...
                <h3 className='text-lg font-bold text-[#112D4E] mb-3'>Audit & stratégie digitale locale</h3>
                <p className='text-gray-600'>Analyse de vos concurrents à Toulouse et étude de votre marché.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Maquettes adaptées à votre identité visuelle et à vos clients cibles.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Site responsive, rapide, conforme aux standards web.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Contenus adaptés à Toulouse, balises meta, vitesse, mobile-first.</p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>Indexation Google, monitoring des performances et ajustements continus.</p>
              </div>
            </div>
          </div>
        </Section>
          ...
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='space-y-8'>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                ...
                <p className='text-gray-600'>
                  En moyenne <strong>4 à 8 semaines</strong>, selon la complexité du projet et la disponibilité des contenus.
                </p>
              </div>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                ...
                <p className='text-gray-600'>
                  Oui. Tous nos sites sont optimisés pour le <strong>référencement SEO à Toulouse</strong>, 
                  afin de maximiser votre visibilité locale.
                </p>
              </div>
              ...
              <div className='bg-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                ...
                <p className='text-gray-600'>
                  Oui. Nous proposons des CMS simples et une formation pour gérer vos textes, images et contenus.
                </p>
              </div>
            </div>
          </div>
        ...
        <Section className='py-20 bg-gradient-to-br from-[#112D4E] to-[#3F72AF] text-white'>
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            <h2 className='text-4xl font-bold mb-6'>
              Demandez votre devis gratuit à Toulouse
            </h2>
            <p className='text-xl mb-8 opacity-90'>
              Vous souhaitez renforcer votre présence en ligne et attirer de nouveaux clients à <strong>Toulouse</strong> ?<br />
              Confiez-nous la <strong>création de votre site internet</strong> et bénéficiez d&apos;une solution moderne, efficace et optimisée pour le SEO local.
            </p>
