            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              <div className='text-center mb-16'>
                ...
                <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                  Today, a café without a website visible on Google loses potential customers. 
                  A <strong>Paris-optimized website</strong> allows:
                </p>
              </div>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    <strong>Showcase your menus</strong> and specialties (coffee, drinks, pastries, brunch).
                  </p>
                </div>
                ...
                <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    <strong>Improve your local visibility</strong> and attract residents and tourists.
                  </p>
                </div>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Professional showcase website</h3>
                  <p className='text-gray-600 mb-6'>
                    Present your café with a <strong>modern design</strong>, your hours, address and values.
                  </p>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Enable <strong>online product sales</strong>: coffee beans, pastries, subscriptions or gift cards.
                  </p>
                  <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                    Learn more
                    <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Features adapted to cafés</h3>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Local SEO for cafés in Paris</h3>
                  <p className='text-gray-600 mb-6'>
                    Content optimization, meta tags, Google Business Profile, customer reviews and geolocation to appear at the top of searches: 
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Design & user experience</h3>
                  <p className='text-gray-600 mb-6'>
                    Smooth navigation, responsive design, <strong>attractive photos and videos</strong> to seduce your visitors and convert them into customers.
                  </p>
                  <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                    Learn more
                    <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Maintenance & technical support</h3>
                  <p className='text-gray-600 mb-6'>
                    Regular updates, security, <strong>backups and dedicated assistance</strong> to ensure your site&apos;s performance.
                  </p>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-xl p-6 border border-gray-100'>
                  ...
                  <h3 className='text-lg font-bold text-[#112D4E] mb-3'>Increased visibility in Paris</h3>
                ...
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-xl p-6 border border-gray-100'>
                  ...
                  <h3 className='text-lg font-bold text-[#112D4E] mb-3'>Better informed customers</h3>
          ...
          <Section className='py-20 bg-gradient-to-b from-[#F8F9FA] to-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
              ...
              <p className='text-xl text-gray-600 mb-8'>
                Discover our work for Parisian cafés and restaurants. 
                See our results in local SEO and modern design.
              </p>
            ...
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='space-y-8'>
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    The price varies according to the type of site and desired features. 
                    Contact us for a <strong>free and personalized quote</strong>.
                  </p>
                </div>
                ...
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    On average <strong>4 to 8 weeks</strong>, depending on complexity and content provided.
                  </p>
                </div>
          ...
          <Section className='py-20 bg-gradient-to-br from-[#112D4E] to-[#3F72AF] text-white'>
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
              ...
              <p className='text-xl mb-8 opacity-90'>
                Do you want to <strong>attract more customers to your café in Paris</strong> and improve your online visibility?<br />
                Trust us with the <strong>creation of your professional website</strong>, SEO and multilingual optimized, 
                to transform your visitors into loyal customers.
              </p>
        ...
        <div className='flex flex-col gap-0'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
                <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    <strong>Представить ваши меню</strong> и фирменные блюда (кофе, напитки, выпечка, бранч).
                  </p>
                </div>
                ...
                <div className='bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    Обеспечить <strong>современный пользовательский опыт</strong> и мобильный интерфейс.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Профессиональный сайт-витрина</h3>
                  <p className='text-gray-600 mb-6'>
                    Представьте ваше кафе с <strong>современным дизайном</strong>, расписанием, адресом и ценностями.
                  </p>
                  <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                    Подробнее
                    <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Интернет-магазин для кафе</h3>
                  <p className='text-gray-600 mb-6'>
                    Обеспечьте <strong>онлайн-продажу продуктов</strong>: кофе в зернах, выпечка, подписки или подарочные карты.
                  </p>
                  <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                    Подробнее
                    <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Функции, адаптированные для кафе</h3>
                  <div className='text-gray-600 space-y-2 mb-6'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Локальное SEO для кафе в Париже</h3>
                  <p className='text-gray-600 mb-6'>
                    Оптимизация контента, мета-теги, Google Business Profile, отзывы клиентов и геолокация для появления в топе поисков: 
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Дизайн и пользовательский опыт</h3>
                  <p className='text-gray-600 mb-6'>
                    Плавная навигация, адаптивный дизайн, <strong>привлекательные фото и видео</strong> для привлечения посетителей и их превращения в клиентов.
                  </p>
                  <Link href='/services/creation-sites-web' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                    Подробнее
                    <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                ...
                <div className='bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100'>
                  ...
                  <h3 className='text-xl font-bold text-[#112D4E] mb-4'>Обслуживание и техническая поддержка</h3>
                  <p className='text-gray-600 mb-6'>
                    Регулярные обновления, безопасность, <strong>резервные копии и специализированная помощь</strong> для обеспечения производительности вашего сайта.
                  </p>
                  <Link href='/services/maintenance-support' className='text-[#3F72AF] hover:text-[#112D4E] font-semibold inline-flex items-center group'>
                    Подробнее
                    <svg className='w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-xl p-6 border border-gray-100'>
                  ...
                  <h3 className='text-lg font-bold text-[#112D4E] mb-3'>Повышенная видимость в Париже</h3>
                ...
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-xl p-6 border border-gray-100'>
                  ...
                  <h3 className='text-lg font-bold text-[#112D4E] mb-3'>Лучше информированные клиенты</h3>
          ...
          <Section className='py-20 bg-gradient-to-b from-[#F8F9FA] to-white'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
              ...
              <p className='text-xl text-gray-600 mb-8'>
                Ознакомьтесь с нашими работами для парижских кафе и ресторанов. 
                Убедитесь в наших результатах в локальном SEO и современном дизайне.
              </p>
              <CTAButton href='/projects' size='lg' className='mx-auto'>
            ...
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
              ...
              <div className='space-y-8'>
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    Цена варьируется в зависимости от типа сайта и желаемых функций. 
                    Свяжитесь с нами для получения <strong>бесплатного и персонализированного предложения</strong>.
                  </p>
                </div>
                ...
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    В среднем <strong>от 4 до 8 недель</strong>, в зависимости от сложности и предоставленного контента.
                  </p>
                </div>
                ...
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    Да. Каждый сайт разработан с <strong>локальной SEO-стратегией для Парижа</strong>, 
                    чтобы максимизировать видимость среди близлежащих клиентов.
                  </p>
                </div>
                ...
                <div className='bg-gradient-to-br from-[#F8F9FA] to-white rounded-2xl p-8 shadow-lg border border-gray-100'>
                  ...
                  <p className='text-gray-600'>
                    Да. Мы предоставляем простое обучение для обновления ваших меню, изображений и текстов.
                  </p>
                </div>
              </div>
            </div>
          ...
          <Section className='py-20 bg-gradient-to-br from-[#112D4E] to-[#3F72AF] text-white'>
            <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
              ...
              <p className='text-xl mb-8 opacity-90'>
                Хотите <strong>привлечь больше клиентов в ваше кафе в Париже</strong> и улучшить вашу онлайн-видимость?<br />
                Доверьте нам <strong>создание вашего профессионального сайта</strong>, оптимизированного для SEO и многоязычного, 
                чтобы превратить ваших посетителей в постоянных клиентов.
              </p>
