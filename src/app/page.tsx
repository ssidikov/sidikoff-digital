          ...
          <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32'>
            <div className='mx-auto max-w-4xl'>
              ...
              <p className='mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-slate-300'>
                Современные веб-решения с использованием передовых технологий. Next.js, TypeScript и
                красивый дизайн для вашего успеха.
              </p>
          ...
          <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl md:text-center'>
              ...
              <p className='mt-4 text-lg tracking-tight text-slate-700 dark:text-slate-300'>
                Мы используем самые современные технологии для создания быстрых и красивых
                веб-сайтов.
              </p>
            </div>
            <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
              <dl className='grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3'>
                <div className='flex flex-col'>
                  ...
                  <dd className='mt-4 flex flex-auto flex-col text-base leading-7 text-slate-600 dark:text-slate-400'>
                    <p className='flex-auto'>
                      Оптимизация производительности и современные технологии обеспечивают быструю
                      загрузку страниц.
                    </p>
                  </dd>
                </div>
                <div className='flex flex-col'>
                  ...
                  <dd className='mt-4 flex flex-auto flex-col text-base leading-7 text-slate-600 dark:text-slate-400'>
                    <p className='flex-auto'>
                      Адаптивный дизайн, который отлично выглядит на всех устройствах - от мобильных
                      до десктопов.
                    </p>
                  </dd>
                </div>
                <div className='flex flex-col'>
                  ...
                  <dd className='mt-4 flex flex-auto flex-col text-base leading-7 text-slate-600 dark:text-slate-400'>
                    <p className='flex-auto'>
                      TypeScript обеспечивает типобезопасность и помогает избежать ошибок на этапе
                      разработки.
                    </p>
                  </dd>
                </div>
