...
const STYLES = {
  ...
  badge: 'inline-flex items-center px-4 py-2 rounded-full text-sm font-medium mb-8 bg-gradient-to-r from-blue-50 to-purple-50 text-blue-700 border border-blue-200/50',
  ...
  ctaGradient: 'absolute inset-0 bg-gradient-to-r from-gray-900 to-gray-800',
  
  ctaPattern: 'absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.15)_1px,transparent_0)] bg-[length:20px_20px]',
  
  ctaContainer: 'relative z-10 container mx-auto px-4 text-center',
  
  ctaContent: 'max-w-4xl mx-auto',
  
  ctaIcon: 'w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-8',
  ...
  primaryButton: 'group relative bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/25 transform hover:-translate-y-1',
  
  secondaryButton: 'group relative bg-transparent text-white border-2 border-white/30 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-white hover:text-gray-900 transform hover:-translate-y-1',
    ...
    <Section variant='blog' background='transparent' padding='none' contentWidth='full'>
      ...
      <section className={STYLES.mainContent}>
        <div className={STYLES.container}>
          ...
          {hasNoPosts && (
            <motion.div
              {...ANIMATION_CONFIG.noResults}
              className={STYLES.noResults.container}>
              ...
              <h3 className={STYLES.noResults.title}>
                {dictionary.no_posts}
              </h3>
