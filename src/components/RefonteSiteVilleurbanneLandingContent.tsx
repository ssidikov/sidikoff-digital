...
export default function RefonteSiteVilleurbanneLandingContent() {
  return (
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-slate-900">
        <div className="absolute inset-0 z-0 opacity-20">
          <Image
            ...
            alt="Refonte de site internet Villeurbanne"
            fill
            ...
            >
              ...
              <div>
                ...
                <p className="text-xl text-slate-300 leading-relaxed mb-8">
                  Votre site est lent, n'attire plus de clients ou ne reflète plus votre image ? Notre équipe s'occupe de la refonte complète de votre site pour les entreprises de Villeurbanne et du Grand Lyon.
                </p>
              </div>
