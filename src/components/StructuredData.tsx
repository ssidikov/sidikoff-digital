...
export default function StructuredData() {
  const organizationSchema = {
    ...
    description: 'Professional web development agency specializing in modern websites and applications using Next.js, React, and TypeScript.',
    address: {
      '@type': 'PostalAddress',
  ...
  const websiteSchema = {
    ...
    alternateName: 'SIDIKOFF',
    url: 'https://sidikoff.digital',
    description: 'Professional web development agency specializing in modern websites and applications.',
    inLanguage: ['en', 'ru', 'fr'],
    potentialAction: {
      '@type': 'SearchAction',
      target: {
  ...
  const serviceSchema = {
    ...
    description: 'Professional web development services including modern website creation, web applications, and digital solutions.',
    provider: {
      '@type': 'Organization',
      name: 'SIDIKOFF Digital'
    },
