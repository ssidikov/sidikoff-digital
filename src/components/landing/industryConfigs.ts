...
export const industryConfigs: Record<IndustryType, IndustryConfig> = {
  restaurant: {
    ...
    meta: {
      ...
      description:
        'Professional restaurant website creation with online menu, reservations, and delivery integration',
    },
  },
  ...
  'travel-agency': {
    ...
    meta: {
      ...
      description:
        'Modern travel agency websites with booking system, destination guides, and customer management',
    },
  },
  ...
  barbershop: {
    ...
    meta: {
      ...
      description:
        'Professional barbershop websites with online booking, service showcase, and customer management',
    },
  },
  ...
  doctor: {
    ...
    meta: {
      ...
      description:
        'Professional medical practice websites with appointment booking, patient portal, and healthcare information',
    },
  },
  ...
  photographer: {
    ...
    meta: {
      ...
      description:
        'Stunning photography websites with portfolio galleries, booking system, and client management',
    },
  },
  ...
  boulangerie: {
    ...
    meta: {
      ...
      description:
        'Artisan bakery websites with product showcase, online ordering, and location information',
    },
  },
  ...
  freelance: {
    ...
    meta: {
      ...
      description:
        'Professional freelance websites with portfolio showcase, service offerings, and client testimonials',
    },
  },
  ...
  ecommerce: {
    ...
    meta: {
      ...
      description:
        'Complete e-commerce solutions with product catalog, secure payment processing, and inventory management',
    },
  },
  ...
  'web-creation': {
    ...
    meta: {
      ...
      description:
        'Professional website creation services with modern design, responsive layout, and SEO optimization',
    },
  },
  ...
  'web-redesign': {
    ...
    meta: {
      ...
      description:
        'Website redesign and modernization services to improve performance, design, and user experience',
    },
  },
  ...
  'seo-optimization': {
    ...
    meta: {
      ...
      description:
        'Comprehensive SEO optimization services to improve search rankings and organic traffic',
    },
  },
  ...
  maintenance: {
    ...
    meta: {
      ...
      description:
        'Professional website maintenance services including updates, security monitoring, and technical support',
    },
  },
}
