...
import { ArrowRight, CheckCircle, Star, Users, Globe, Zap, Code, Smartphone, Search, Award, Mail, Phone } from 'lucide-react'
...
export default function GoneLandingPage({ cityName, locale = 'fr' }: GoneLandingPageProps) {
  ...
  const translations = {
    fr: {
      notice: "Page optimisée : Nous avons simplifié notre site pour vous offrir une meilleure expérience",
      mainTitle: "Création de sites web",
      titleHighlight: "modernes en France",
      subtitle: "Développeur React/Next.js spécialisé en solutions digitales sur mesure. Transformez votre présence en ligne avec des sites web performants et optimisés.",
      ...
      testimonial: "Un travail exceptionnel ! Mon site e-commerce développé par Sidikoff Digital a dépassé toutes mes attentes. Performance, design et référencement au top. Je recommande vivement !",
      ...
      footerDescription: "Développeur React/Next.js spécialisé en création de sites web modernes et performants.",
    ...
    en: {
      ...
      subtitle: "React/Next.js developer specialized in custom digital solutions. Transform your online presence with high-performance, optimized websites.",
      ...
      testimonial: "Exceptional work! My e-commerce site developed by Sidikoff Digital exceeded all my expectations. Performance, design and SEO at the top. I highly recommend!",
      testimonialAuthor: "Marie Dubois",
      ...
      footerDescription: "React/Next.js developer specialized in creating modern and performant websites.",
    ...
    ru: {
      ...
      subtitle: "React/Next.js разработчик, специализирующийся на индивидуальных цифровых решениях. Преобразите свое онлайн-присутствие с помощью высокопроизводительных, оптимизированных веб-сайтов.",
      ...
      testimonial: "Исключительная работа! Мой сайт электронной коммерции, разработанный Sidikoff Digital, превзошел все мои ожидания. Производительность, дизайн и SEO на высшем уровне. Настоятельно рекомендую!",
      ...
      footerDescription: "React/Next.js разработчик, специализирующийся на создании современных и производительных веб-сайтов.",
  ...
  const services = [
    {
      ...
      title: locale === 'fr' ? "Sites Web Modernes" : locale === 'en' ? "Modern Websites" : "Современные веб-сайты",
      description: locale === 'fr' ? "Création de sites internet avec React, Next.js et design responsive pour tous les appareils." : 
                  locale === 'en' ? "Website creation with React, Next.js and responsive design for all devices." :
                  "Создание веб-сайтов с React, Next.js и адаптивным дизайном для всех устройств."
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: locale === 'fr' ? "E-commerce" : locale === 'en' ? "E-commerce" : "Электронная коммерция",
      description: locale === 'fr' ? "Boutiques en ligne performantes avec solutions de paiement sécurisées et gestion des stocks." :
                  locale === 'en' ? "High-performance online stores with secure payment solutions and inventory management." :
                  "Высокопроизводительные интернет-магазины с безопасными платежными решениями и управлением запасами."
    },
    {
      icon: <Search className="w-8 h-8" />,
      title: locale === 'fr' ? "Optimisation SEO" : locale === 'en' ? "SEO Optimization" : "SEO оптимизация", 
      description: locale === 'fr' ? "Référencement naturel et technique pour améliorer votre visibilité sur Google." :
                  locale === 'en' ? "Natural and technical SEO to improve your visibility on Google." :
  ...
  const features = [
    {
      ...
      title: locale === 'fr' ? "Technologies Modernes" : locale === 'en' ? "Modern Technologies" : "Современные технологии",
      description: "React, Next.js, TypeScript"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: locale === 'fr' ? "Performance Optimisée" : locale === 'en' ? "Optimized Performance" : "Оптимизированная производительность",
      description: locale === 'fr' ? "Sites ultra-rapides et optimisés" : locale === 'en' ? "Ultra-fast and optimized sites" : "Сверхбыстрые и оптимизированные сайты"
    },
    {
      icon: <Award className="w-6 h-6" />,
      title: locale === 'fr' ? "Qualité Garantie" : locale === 'en' ? "Guaranteed Quality" : "Гарантированное качество",
      description: locale === 'fr' ? "Code propre et maintenable" : locale === 'en' ? "Clean and maintainable code" : "Чистый и поддерживаемый код"
    }
  ]
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Solutions digitales & création de sites internet en France – Sidikoff" />
        <meta property="og:description" content="Agence spécialisée en création de sites web, e-commerce et SEO. Nous accompagnons entreprises, indépendants et startups dans toute la France." />
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    <li><Link href="/services" className="hover:text-blue-400 transition-colors">{locale === 'fr' ? 'Création de sites web' : locale === 'en' ? 'Web Development' : 'Веб-разработка'}</Link></li>
                    <li><Link href="/services/creation-site-ecommerce" className="hover:text-blue-400 transition-colors">E-commerce</Link></li>
                    <li><Link href="/services/optimisation-seo" className="hover:text-blue-400 transition-colors">{locale === 'fr' ? 'SEO & Référencement' : locale === 'en' ? 'SEO & Optimization' : 'SEO и оптимизация'}</Link></li>
                    <li><Link href="/services/maintenance-support" className="hover:text-blue-400 transition-colors">{locale === 'fr' ? 'Maintenance' : locale === 'en' ? 'Maintenance' : 'Поддержка'}</Link></li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    <li><Link href="/#portfolio" className="hover:text-blue-400 transition-colors">{t.footerPortfolio}</Link></li>
                    <li><Link href="/contact" className="hover:text-blue-400 transition-colors">{t.footerContact}</Link></li>
                    <li><Link href="/blog" className="hover:text-blue-400 transition-colors">{t.footerBlog}</Link></li>
                    <li><Link href="/mentions-legales" className="hover:text-blue-400 transition-colors">{t.footerLegal}</Link></li>
                  </ul>
                </div>
              </div>
              
              <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; {new Date().getFullYear()} SIDIKOFF DIGITAL. {t.footerRights}</p>
              </div>
            </div>
          </div>
        </footer>
