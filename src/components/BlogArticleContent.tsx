      ...
      <article>
        <section className='relative pt-28 pb-12 lg:pt-36 lg:pb-20'>
          ...
          <div className='relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
            <Link
              href='/blog'
              className='mb-10 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm backdrop-blur transition-colors hover:text-accent'>
            ...
            <motion.div
              ...
              <div>
                <div className='mb-6 flex flex-wrap items-center gap-3'>
                  <span className='inline-flex items-center gap-2 rounded-full bg-slate-950 px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] text-white'>
                    <Sparkles className='h-4 w-4 text-accent' />
                    {post.category}
                  </span>
                  <span className='inline-flex items-center gap-2 rounded-full bg-white/75 px-4 py-2 text-sm font-semibold text-slate-700 shadow-sm ring-1 ring-slate-950/10 backdrop-blur'>
                    <Clock className='h-4 w-4 text-accent' />
                    {readTime} de lecture
                  </span>
                </div>

                <h1 className='font-grotesk text-5xl font-extrabold leading-[0.98] text-[#112D4E] md:text-7xl'>
                  {post.title}
                </h1>
        ...
        <section className='relative pb-24'>
          <div className='mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[240px_minmax(0,820px)_1fr] lg:px-8'>
            <aside className='hidden lg:block'>
              <div className='sticky top-28 rounded-3xl border border-slate-200 bg-white/65 p-5 shadow-sm backdrop-blur'>
            ...
            <motion.div
              ...
              className='rounded-3xl border border-slate-200 bg-white px-6 py-9 shadow-[0_26px_90px_rgba(15,23,42,0.08)] sm:px-10 lg:px-14 lg:py-14'>
              <div
                className='article-prose text-lg leading-9 text-slate-700
                  [&>h2]:mt-14 [&>h2]:font-grotesk [&>h2]:text-3xl [&>h2]:font-bold [&>h2]:leading-tight [&>h2]:text-[#112D4E]
                  [&>h2:first-child]:mt-0
                  [&>p]:mb-7
                  [&>ul]:my-7 [&>ul]:space-y-3 [&>ul]:pl-0
                  [&>ol]:my-7 [&>ol]:space-y-3 [&>ol]:pl-6
                  [&>ul>li]:relative [&>ul>li]:list-none [&>ul>li]:pl-7
                  [&>ul>li]:before:absolute [&>ul>li]:before:left-0 [&>ul>li]:before:top-[0.72em] [&>ul>li]:before:h-2 [&>ul>li]:before:w-2 [&>ul>li]:before:rounded-full [&>ul>li]:before:bg-accent
                  [&>ol>li]:pl-2
                  [&_strong]:font-bold [&_strong]:text-[#112D4E]
              ...
              <div className='mt-16 overflow-hidden rounded-3xl bg-slate-950 p-7 text-white sm:p-9'>
                <div className='grid gap-7 md:grid-cols-[1fr_auto] md:items-center'>
                  <div>
                    <h3 className='font-grotesk text-3xl font-bold'>Besoin d&apos;un regard expert ?</h3>
                  ...
                  <Link
                    href='/contact'
                    className='inline-flex items-center justify-center gap-3 rounded-full bg-accent hover:bg-accent-dark px-6 py-4 text-sm font-semibold text-white transition-all duration-300 shadow-md hover:shadow-lg'>
                    Contactez-nous
