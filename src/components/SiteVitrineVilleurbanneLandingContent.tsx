...
const benefits = [
  "Création de site internet sur-mesure (vitrine) basé à Villeurbanne",
  "Design premium et ergonomie pensée pour la conversion",
  "Optimisation mobile (Responsive) et performances (Core Web Vitals)",
  "Optimisation SEO local pour être visible sur Google à Villeurbanne",
...
const services = [
  {
    ...
    description: 'Fini les templates vus mille fois. Nous concevons une identité visuelle unique qui reflète le professionnalisme de votre entreprise villeurbannaise.'
  },
  {
    icon: Smartphone,
...
const faqItems = [
  {
    id: '1',
    question: 'Quel est le prix pour la création d\'un site vitrine à Villeurbanne ?',
  ...
  },
  {
    ...
    answer: 'Chaque site que nous développons inclut une base SEO solide : balises meta optimisées, structure Hn propre, sitemap XML, et rapidité de chargement. Pour dominer des mots-clés très concurrentiels sur Villeurbanne, nous proposons des forfaits d\'accompagnement SEO mensuel dédiés.',
    category: 'seo'
  },
  {
    id: '5',
...
export default function SiteVitrineVilleurbanneLandingContent() {
  return (
            ...
            >
              ...
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                  Votre Site <span className="text-emerald-400">Vitrine</span> à Villeurbanne
                </h1>
                <p className="text-xl text-slate-300 leading-relaxed mb-8">
                  Démarquez-vous de la concurrence avec un site internet premium, rapide et optimisé pour générer des contacts de qualité dans toute la métropole de Lyon.
                </p>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-8">
              Pourquoi votre entreprise à Villeurbanne a-t-elle besoin d'un site vitrine pro ?
            </h2>
            <div className="prose prose-lg text-slate-700 space-y-6">
              ...
              <p>
                En tant qu'<strong>agence web à Villeurbanne</strong>, nous ne nous contentons pas d'assembler des pages. Nous pensons votre site comme un tunnel de conversion. Le parcours utilisateur (UX) est pensé pour guider le visiteur naturellement vers la prise de contact (demande de devis, appel téléphonique, formulaire).
              </p>
              <p>
                De plus, un site internet performant vous donne de la crédibilité. Que vous soyez artisan, profession libérale, consultant ou gérant de PME à Villeurbanne, posséder un site vitrine moderne, rapide et optimisé pour le référencement (SEO) est la base indispensable de toute stratégie digitale réussie.
              </p>
            </div>
          </motion.div>
        </div>
