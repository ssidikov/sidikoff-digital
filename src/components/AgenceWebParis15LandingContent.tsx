...
export default function AgenceWebParis15LandingContent({
  ...
  return (
    <main
      className='min-h-screen bg-linear-to-br from-slate-50 via-purple-50/30 to-pink-50/20'
              ...
              (service: { icon: string; title: string; description: string }, index: number) => {
                ...
                return (
                  <motion.div
                    ...
                    <div className='p-8'>
                      <h3
                        className='text-2xl font-black text-slate-900 mb-4 group-hover:text-indigo-600 transition-colors'
                        style={{ fontFamily: 'var(--font-grotesk, system-ui)' }}>
                        {service.title}
                      </h3>
