...
const benefits = [
  ...
  "Stratégie de référencement local spécifique à Lyon",
...
const services = [
  ...
  },
  {
    ...
    description: 'Optimisation de votre fiche Google Business Profile et création de citations locales pour dominer les recherches géolocalisées sur Lyon et sa région.'
  },
  {
    icon: FileSearch,
...
export default function SeoLyonLandingContent() {
  return (
            ...
            >
              ...
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                  Expertise <span className="text-rose-400">SEO</span> à Lyon : Dominez Google
                </h1>
                <p className="text-xl text-slate-300 leading-relaxed mb-8">
                  Multipliez votre trafic qualifié et vos ventes grâce à une stratégie de référencement naturel pérenne. Audit complet, optimisation locale et netlinking sur Lyon.
                </p>
              </div>
                ...
                <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-slate-200">
                  <div className="p-6 border-b border-slate-100 flex items-center bg-slate-50">
                     <div className="flex-1 h-12 bg-white border border-slate-200 rounded-full flex items-center px-6 shadow-sm">
                       <span className="text-slate-800 font-medium">entreprise lyon</span>
                    ...
                    <div className="relative">
                      ...
                      <div className="bg-rose-50/50 p-4 rounded-lg border border-rose-100 pl-8">
                        ...
                        <div className="text-xl text-blue-800 font-medium hover:underline cursor-pointer mb-2">
                          Votre Entreprise à Lyon - Le Spécialiste N°1
                        </div>
                        <div className="text-sm text-slate-600 leading-relaxed">
                          Découvrez nos services professionnels à Lyon. Devis gratuit, intervention rapide et qualité garantie. Contactez notre équipe dès aujourd'hui.
                        </div>
                      </div>
                    </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-8">
              Pourquoi investir dans le référencement naturel (SEO) à Lyon ?
            </h2>
            <div className="prose prose-lg text-slate-700 space-y-6">
              <p>
                Être visible sur Google n'est plus un avantage concurrentiel, c'est une nécessité vitale. Chaque jour, des milliers d'internautes recherchent des prestataires, des artisans ou des commerçants à Lyon. Si votre entreprise basée à <strong>Lyon</strong> n'apparaît pas dans les trois premiers résultats de la première page, vous laissez mécaniquement ce chiffre d'affaires à vos concurrents.
              </p>
              <p>
                Le SEO (Search Engine Optimization) consiste à optimiser techniquement et sémantiquement votre site internet pour que l'algorithme de Google le considère comme la réponse la plus pertinente à la recherche de l'utilisateur. En tant qu'<strong>agence SEO intervenant à Lyon</strong>, notre objectif est clair : capter l'intention d'achat au moment précis où le besoin se fait sentir.
              </p>
              <p>
