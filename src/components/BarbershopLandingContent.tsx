          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            <motion.div
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                <Link
                  href={contactUrl}
                  className='inline-flex items-center justify-center px-8 py-4 bg-slate-900 text-white font-semibold rounded-lg hover:bg-slate-800 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-200'>
                  {t.hero.cta_primary}
                  <ArrowRight className='ml-2 w-5 h-5' />
                </Link>
                <Link
                  href='#portfolio'
                  className='inline-flex items-center justify-center px-8 py-4 border-2 border-slate-300 text-slate-700 font-semibold rounded-lg hover:border-slate-400 hover:text-slate-900 transition-colors'>
            ...
            <motion.div
              ...
              <div className='absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg border border-slate-100'>
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    <p className='font-semibold text-slate-900'>+50 Barbershops</p>
                    <p className='text-sm text-slate-600'>Sites créés avec succès</p>
                  </div>
                </div>
              </div>
            </motion.div>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-slate-600'>
                      {review.position} - {review.barbershop}
                    </p>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <motion.div
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link
                href={contactUrl}
                className='inline-flex items-center justify-center px-8 py-4 bg-white text-slate-900 font-semibold rounded-lg hover:bg-slate-100 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 duration-200'>
