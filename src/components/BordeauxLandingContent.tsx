...
const services = [
  {
    ...
    description:
      'Conception de sites internet au design unique pour affirmer votre identité de marque face à la concurrence bordelaise.',
  },
  {
    icon: Search,
    title: 'Référencement Naturel (SEO)',
    description:
      'Stratégie de mots-clés transactionnels pour placer votre entreprise en tête des recherches Google sur Bordeaux et la Gironde.',
  },
  {
    icon: Zap,
    title: 'Vitesse & Core Web Vitals',
    description:
      'Développement avec React et Next.js garantissant des temps de chargement ultra-rapides, essentiels pour la conversion.',
  },
  {
    icon: Code,
    title: "Développement d'Applications",
    description:
      "Création d'outils métiers, de plateformes SaaS et de portails web complexes pour digitaliser vos processus.",
  },
  {
    icon: PenTool,
    title: 'UX/UI Design',
    description:
      "Maquettage et parcours utilisateur pensés pour maximiser l'engagement de vos visiteurs et générer des leads qualifiés.",
  },
  {
    icon: Monitor,
    title: 'Maintenance & Sécurité',
    description:
      'Hébergement sécurisé, mises à jour techniques régulières et sauvegardes quotidiennes de vos données.',
  },
]
...
const processSteps = [
  {
    ...
    description:
      "Analyse de votre marché cible à Bordeaux et définition de l'arborescence idéale pour votre projet web.",
  },
  {
    number: '02',
    title: 'Maquettage UI/UX',
    description:
      "Création des designs sur-mesure validés ensemble pour s'assurer qu'ils reflètent parfaitement votre image.",
  },
  {
    number: '03',
    title: 'Développement & SEO',
    description:
      'Intégration pixel-perfect avec un code propre et optimisation des balises pour le référencement naturel.',
  },
  {
    number: '04',
    title: 'Mise en ligne & Suivi',
    description:
      "Déploiement sur votre domaine, formation à l'outil d'administration et suivi de vos positions.",
  },
]
...
const faqItems = [
  {
    ...
    answer:
      "Le tarif dépend de la complexité de votre projet. Un site vitrine professionnel démarre à 990€, tandis qu'un site plus complexe avec une stratégie SEO locale ou des fonctionnalités e-commerce se situe entre 1990€ et 3000€+. Nous proposons des devis précis après un échange gratuit.",
    category: 'pricing',
  },
  {
    id: '2',
    ...
    answer:
      'Oui, l\'optimisation SEO locale est au cœur de notre processus de création. Votre site sera techniquement structuré pour plaire à Google, avec des balises optimisées pour des requêtes telles que "votre métier + Bordeaux", afin d\'attirer des clients de la région.',
    category: 'seo',
  },
  {
    id: '3',
    ...
    answer:
      "Bien que notre siège soit basé en région lyonnaise, nous accompagnons de nombreuses entreprises de la Nouvelle-Aquitaine et de La French Tech Bordeaux. Grâce aux outils collaboratifs (Visio, Slack, Figma), la distance n'est jamais un frein, et nous offrons la même qualité de service de proximité.",
    category: 'location',
  },
  {
    id: '4',
    ...
    answer:
      'Vous avez le choix. Vous pouvez fournir vos propres contenus, ou faire appel à notre équipe de copywriters spécialisés. Ils rédigeront des textes persuasifs, orientés pour la conversion de vos clients et optimisés pour le SEO.',
    category: 'content',
  },
  {
    id: '5',
    ...
    answer:
      "Absolument. Une fois la facture finale réglée, vous êtes le seul et unique propriétaire de votre site, de son code source et de votre nom de domaine. Vous n'êtes lié par aucun abonnement restrictif.",
    category: 'ownership',
  },
  {
    id: '6',
    ...
    answer:
      'Oui, nous développons sur des CMS intuitifs ou des solutions headless avec un back-office sur-mesure. Une formation est incluse pour que vous puissiez modifier vos textes, ajouter des photos ou des articles de blog en toute autonomie.',
    category: 'tech',
  },
  {
    id: '7',
    ...
    answer:
      'Tout à fait. Nous reprenons votre site vieillissant, améliorons son design, ses performances (souvent ralenties par WordPress) et mettons en place un plan de redirections (301) rigoureux pour conserver votre référencement acquis.',
    category: 'refonte',
  },
  {
    id: '8',
    ...
    answer:
      'Pour un site vitrine classique de 5 à 10 pages, comptez environ 4 à 6 semaines. Ce délai peut varier en fonction de vos retours sur les maquettes et de la rapidité de validation des contenus.',
    category: 'timing',
  },
]
...
export default function BordeauxLandingContent() {
  return (
    <div className='min-h-screen bg-slate-50'>
      {/* Hero Section */}
      <section className='relative pt-32 pb-20 overflow-hidden bg-[#1A0B14]'>
        {' '}
        {/* Deep Wine Base */}
            ...
            <motion.div
              ...
              <div>
                <h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6'>
                  Propulsez votre présence en ligne à{' '}
                  <span className='text-[#E5B558]'>Bordeaux</span>
                </h1>
                <p className='text-xl text-slate-300 leading-relaxed mb-8'>
                  Création de sites internet premium, ultra-rapides et optimisés pour le
                  référencement naturel. Transformez vos visiteurs en clients fidèles.
                </p>
              </div>
                ...
                <div className='bg-slate-900 rounded-xl overflow-hidden shadow-lg border border-slate-800 relative'>
                  ...
                  <div className='relative aspect-[4/3] bg-[#FDFBF7] overflow-hidden'>
                    ...
                    <div className='absolute inset-0 flex flex-col items-center justify-center text-center p-8'>
                      ...
                      <h3 className='text-3xl font-bold text-[#1A0B14] mb-4 font-serif'>
                        Maison Bordelaise
                      </h3>
                      <p className='text-slate-600 mb-8 max-w-sm'>
                        L'élégance du design couplée à la performance technique pour les entreprises
                        de la région.
                      </p>
                      <div className='px-8 py-3 bg-[#6E1C38] text-white rounded font-medium shadow-md'>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          <motion.div
            ...
            <div className='prose prose-lg text-slate-700 space-y-6'>
              <p>
                Bordeaux et la région Nouvelle-Aquitaine connaissent un essor économique fulgurant,
                porté par <strong>La French Tech Bordeaux</strong> et un écosystème d'entreprises
                innovantes (du quartier des Chartrons à Darwin, en passant par Saint-Michel et
                Mérignac). Dans ce marché hyper-concurrentiel, posséder un simple site internet ne
                suffit plus : il vous faut une machine d'acquisition digitale.
              </p>
              <p>
                En tant qu'<strong>agence web</strong>, nous concevons des plateformes premium qui
                allient l'esthétique raffinée attendue par la clientèle bordelaise, à des
                performances techniques de pointe. Que vous soyez un acteur du monde viticole, de la
                wine-tech, un artisan renommé ou une startup en croissance, votre vitrine digitale
                doit refléter l'excellence de votre savoir-faire.
              </p>
              <p>
                Notre méthodologie repose sur trois piliers :{' '}
                <strong>l'Expérience Utilisateur (UX)</strong> pour guider vos visiteurs vers
                l'action, <strong>la Vitesse d'affichage</strong> (via l'architecture Next.js) pour
                ne perdre aucun prospect impatient, et le{' '}
                <strong>Référencement Naturel (SEO local)</strong>. Nous intégrons les bons
                mots-clés transactionnels dès la conception de vos pages, pour garantir votre
                présence en 1ère page de Google sur Bordeaux.
              </p>
              <p>
                Avoir un site esthétique est primordial, mais s'il est invisible, il ne génère aucun
                chiffre d'affaires. C'est pourquoi nous auditons la sémantique de vos concurrents
                girondins pour élaborer une structure de site capable de capter le trafic de
                qualité, là où vos prospects vous recherchent.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-400'>
              Un accompagnement rigoureux de l'idée jusqu'à la mise en ligne.
            </p>
          </div>
            ...
            {pricingPlans.map((plan, index) => (
              <motion.div
                ...
                className={`relative bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col ${
                  plan.recommended
                    ? 'border-2 border-[#6E1C38] transform md:-translate-y-4'
      ...
      <section className='py-12 bg-slate-50 border-t border-slate-200'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <p className='text-sm text-slate-500 font-medium mb-4 text-center'>
            Découvrez nos autres expertises géographiques & métiers :
          </p>
          <div className='flex flex-wrap justify-center gap-4 text-sm font-medium'>
            <Link
              href='/services/agence-web-paris'
              className='text-slate-600 hover:text-[#6E1C38] transition-colors'>
              Agence Web Paris
            </Link>
      ...
      <section className='py-24 bg-gradient-to-br from-[#1A0B14] to-[#6E1C38] text-white'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <h2 className='text-4xl font-bold mb-6'>
            Prêt à digitaliser votre entreprise bordelaise ?
          </h2>
          <p className='text-xl mb-10 opacity-90 max-w-2xl mx-auto font-medium text-[#E5B558]'>
            Parlons de votre projet. Nous réaliserons une étude personnalisée et gratuite pour vous
            proposer la solution web la plus adaptée à vos objectifs.
          </p>
