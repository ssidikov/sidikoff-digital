...
const techStack = [
  {
    name: 'Next.js 14+',
    desc: 'App Router, Server Components, Streaming',
    color: 'from-gray-900 to-gray-700',
  },
  {
    name: 'React 18+',
    desc: 'Hooks, Context, Suspense, Concurrent',
    color: 'from-blue-600 to-cyan-500',
  },
  {
    name: 'TypeScript',
    desc: 'Typage strict, DX premium, zéro surprises',
    color: 'from-blue-700 to-blue-500',
  },
  {
    name: 'Tailwind CSS',
    desc: 'Design system scalable, purge CSS auto',
    color: 'from-teal-600 to-emerald-500',
  },
  {
    name: 'Vercel / Edge',
    desc: 'Déploiement CDN mondial, latence < 50ms',
    color: 'from-purple-700 to-violet-500',
  },
  {
    name: 'Sanity / Prisma',
    desc: 'CMS headless ou ORM typé selon le projet',
...
const useCases = [
  {
    emoji: '🏢',
    title: 'Sites corporate & institutionnels',
    desc: 'Landing pages haute performance, sites multi-pages avec CMS headless Sanity ou Contentful.',
  },
  {
    emoji: '🛒',
    title: 'E-commerce Next.js',
    desc: 'Intégration Stripe, Shopify Storefront API ou WooCommerce headless. Tunnel de paiement ultra-rapide.',
  },
  {
    emoji: '📱',
    title: 'Applications web React',
    desc: "SaaS, dashboards, outils métier internes — des interfaces complexes avec gestion d'état Zustand ou Redux Toolkit.",
  },
  {
    emoji: '🚀',
    title: 'Startups & scale-ups',
    desc: 'Architecture scalable dès le jour 1. Monorepo Turborepo, tests E2E Playwright, monitoring Sentry.',
  },
  {
    emoji: '🎨',
    title: 'Portfolios & agences créatives',
    desc: 'Animations GSAP ou Framer Motion, effets WebGL, transitions fluides — la vitrine parfaite pour les créatifs.',
  },
  {
    emoji: '📊',
    title: 'Refonte & migration',
    desc: "Migration depuis WordPress, Webflow ou Wix vers Next.js. Stack moderne, performances doublées, coûts d'hébergement réduits.",
  },
]
...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "React est la bibliothèque d'interface utilisateur (UI) développée par Meta. Next.js est un framework construit au-dessus de React qui ajoute le rendu côté serveur (SSR), la génération statique (SSG), le routing automatique, l'optimisation des images et les API Routes. En résumé : React est le moteur, Next.js est la voiture complète prête à rouler en production.",
    category: 'technical',
  },
  {
    id: '3',
    ...
    answer:
      'Le budget dépend de la complexité du projet. Un site vitrine Next.js démarre à partir de 1 290 € avec CMS headless. Une application React sur mesure (dashboard, SaaS, e-commerce) commence autour de 3 000 €. Nous fournissons un devis détaillé et gratuit après un appel de cadrage. Chaque ligne du devis est expliquée et justifiée.',
    category: 'pricing',
  },
  {
    id: '4',
    ...
    answer:
      "Oui, vous êtes propriétaire à 100% du code source. Nous livrons un repo GitHub privé avec documentation technique. Si vous avez des développeurs en interne, ils pourront reprendre le projet facilement. Si vous n'en avez pas, nous proposons des contrats de maintenance et d'évolution.",
    category: 'ownership',
  },
  {
    id: '5',
  ...
  },
  {
    ...
    answer:
      'Un site vitrine Next.js avec CMS prend 2 à 4 semaines. Une application React complexe (authentification, base de données, API) nécessite 6 à 12 semaines selon la portée fonctionnelle. Nous travaillons en sprints avec des livrables intermédiaires visibles pour vous tenir informé à chaque étape.',
    category: 'timing',
  },
]
        ...
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-14'>
            ...
            <p className='mt-4 text-lg text-white/55 max-w-2xl mx-auto'>
              Chaque technologie est choisie pour sa maturité, sa performance et son impact sur le
          ...
          <div className='grid grid-cols-2 md:grid-cols-3 gap-4'>
            {techStack.map((tech, i) => (
              <motion.div
                ...
                <div
                  className={`inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r ${tech.color} px-3 py-1 text-xs font-bold text-white mb-4`}>
          ...
          <div className='grid lg:grid-cols-2 gap-16 items-start'>
            <div>
              ...
              <p className='text-lg text-white/55 leading-relaxed mb-8'>
                Du site vitrine ultra-performant à l&apos;application web React complexe — notre
                équipe maîtrise l&apos;ensemble du front end moderne. Composants réutilisables,
                développement web typé TypeScript, marketing digital orienté performance.
              </p>
              <Link
                href='/contact'
      ...
      <section className='py-20 bg-[#09090b]'>
        <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-white/55 max-w-2xl mx-auto mb-10'>
            Nous intervenons dans tous les arrondissements parisiens. Besoin d&apos;un devis local
            pour votre projet React ou Next.js ?
          </p>
