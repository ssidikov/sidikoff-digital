...
export default function Pricing({
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      price: dict?.pricing?.plans?.business?.price || "Sur devis",
      period: "",
      description:
          ...
          >
            ...
            {dict.pricing.guide_section.website_types && (
              ...
              >
                ...
                <div className="grid md:grid-cols-1 gap-8">
                  {dict.pricing.guide_section.website_types.types?.map(
                    (type, index) => (
                      <motion.div
                        key={index}
                        ...
                        <div className="grid md:grid-cols-2 gap-4 text-sm">
                          <div>
                            <p className="font-semibold text-gray-800 mb-2">
                              🎯{" "}
                              {dict?.pricing?.guide_section?.labels
                          ...
                          <div>
                            <p className="font-semibold text-gray-800 mb-2">
                              💡{" "}
                              {dict?.pricing?.guide_section?.labels
                                ?.recommended_plan || "Plan recommandé:"}
                            </p>
            ...
            {dict.pricing.guide_section.support_importance && (
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {dict.pricing.guide_section.support_importance.benefits?.map(
                    (benefit, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, y: 20 }}
            ...
            {dict.pricing.guide_section.seo_benefits && (
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {dict.pricing.guide_section.seo_benefits.benefits?.map(
                    (benefit, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, y: 20 }}
            ...
            {dict.pricing.guide_section.future_services && (
              ...
              >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {dict.pricing.guide_section.future_services.services?.map(
                    (service, index) => (
                      <motion.div
                        key={index}
                        initial={{ opacity: 0, scale: 0.9 }}
            ...
            <div className="relative">
              ...
              >
                <div className="flex-1">
                  <div className="p-6">
                    <h4 className="text-xl font-bold text-primary mb-2">
                      {dict?.pricing?.maintenance?.plans?.essentiel?.name ||
                        "Essentiel"}
                    </h4>
                    <div className="text-3xl font-bold mb-2">
                      {dict?.pricing?.maintenance?.plans?.essentiel?.price ||
                        "69 €/mois"}
                    </div>
                    <p className="mb-6">
                      {dict?.pricing?.maintenance?.plans?.essentiel
                        ?.description ||
                ...
                <div className="p-6 pt-0 mt-auto">
                  ...
                  >
                    {dict?.pricing?.maintenance?.plans?.essentiel?.cta ||
                      "Choisir Essentiel"}
                  </CTAButton>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="p-6">
                    ...
                    <p className="mb-6">
                      {dict?.pricing?.maintenance?.plans?.croissance
                        ?.description ||
                ...
                <div className="p-6 pt-0 mt-auto">
                  ...
                  >
                    {dict?.pricing?.maintenance?.plans?.croissance?.cta ||
                      "Choisir Croissance"}
                  </CTAButton>
                </div>
              </motion.div>
              ...
              >
                <div className="flex-1">
                  <div className="p-6">
                    ...
                    <p className="mb-6">
                      {dict?.pricing?.maintenance?.plans?.performance
                        ?.description ||
                ...
                <div className="p-6 pt-0 mt-auto">
                  ...
                  >
                    {dict?.pricing?.maintenance?.plans?.performance?.cta ||
                      "Choisir Performance"}
                  </CTAButton>
                </div>
              </motion.div>
