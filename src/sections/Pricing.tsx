  ...
  return (
    <Section
      ...
      <div className='relative z-10'>
        ...
        {/* Section des plans de maintenance — Affichage complet sur /tarifs, bannière condensée sur Home */}
        {!showGuide ? (
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className='inline-flex flex-col sm:flex-row items-center justify-between gap-4 rounded-2xl border border-[#112D4E]/10 bg-white px-6 py-4 shadow-xs max-w-3xl mx-auto'>
              <div className='flex items-center gap-3 text-left'>
                <span className='h-2.5 w-2.5 shrink-0 rounded-full bg-emerald-500' />
                <div>
                  <p className='text-sm font-bold text-[#112D4E]'>
                    Besoin d&apos;un accompagnement continu &amp; support mensuel ?
                  </p>
                  <p className='text-xs text-slate-500'>
                    Forfaits de maintenance, hébergement et SEO continu dès 69 €/mois.
                  </p>
                </div>
              </div>
              <CTAButton
                ...
                size='sm'
                href='/tarifs'
                trackingAction='view_maintenance_pricing'
                trackingCategory='pricing'
                className='shrink-0'>
              ...
              <div className='relative'>
                <motion.div
                  ...
                  <div className='flex-1'>
                    <div className='p-6'>
                      <h4 className='text-xl font-bold text-primary mb-2'>
                        {dict?.pricing?.maintenance?.plans?.croissance?.name || 'Croissance + SEO'}
                      </h4>
                      <div className='text-3xl font-bold mb-2'>
