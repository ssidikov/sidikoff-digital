            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-4 lg:space-y-6'>
                <a
                  ...
                  className='group flex items-center space-x-4 lg:space-x-6 cursor-pointer transition-transform duration-200 hover:scale-105'>
                  <div className='flex items-center justify-center w-12 h-12 lg:w-16 lg:h-14 bg-gray-900 rounded-xl shadow-lg transition-all duration-300 group-hover:bg-accent group-hover:scale-110'>
                    <Mail className='w-6 h-6 lg:w-8 lg:h-8 text-white' />
                  </div>
                  <span className='break-all text-lg font-medium text-gray-600 transition-colors duration-200 group-hover:text-accent lg:text-xl xl:text-2xl'>
                    {CONTACT_INFO.email}
                  </span>
                </a>
                ...
                <a
                  ...
                  <span className='text-lg font-medium text-gray-600 transition-colors duration-200 group-hover:text-accent lg:text-xl xl:text-2xl'>
                    {CONTACT_INFO.phone}
                  </span>
                </a>
