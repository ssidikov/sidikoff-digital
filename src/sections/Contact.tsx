    ...
    <Section
      ...
      <div className='relative z-10'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start'>
            ...
            <div className='space-y-6'>
              ...
              <div className='space-y-6'>
                <div className='flex items-center space-x-6'>
                  <div className='flex items-center justify-center w-14 h-14 bg-gray-900 rounded-xl shadow-sm'>
          ...
          <div className={`p-8 lg:p-10 ${cardStyles.card} relative overflow-hidden`}>
            <div className='mb-8'>
